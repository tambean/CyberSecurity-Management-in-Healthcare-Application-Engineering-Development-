...
public class PharmacistWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public PharmacistWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Medicine Request Table");
        ...
        jLabel10.setText("Prescribed Medicines ");
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        PharamcyWorkRequest request = (PharamcyWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
        if (request.getReceiver() == null) {
            JOptionPane.showMessageDialog(null, "Please first assign  request before you process");
            return;
        }
        if (request.getStatus().matches("Completed")) {
            JOptionPane.showMessageDialog(null, "Request already Completed");
        ...
        userProcessContainer.add("processPharmacyWorkRequestJPanel", processWorkRequestJPanel);
    ...
    private void workRequestJTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_workRequestJTableMouseClicked
        ...
        PharamcyWorkRequest w = (PharamcyWorkRequest) workRequestJTable.getValueAt(selectedRow,0);
        jTextArea1.setText(w.getMedicineNames());
